...
#ifndef __miwu__CBoss__
#define __miwu__CBoss__
...
private:
    ...
    void onEnter();
public:
    CCB_STATIC_NEW_AUTORELEASE_OBJECT_WITH_INIT_METHOD(CBoss, create);
