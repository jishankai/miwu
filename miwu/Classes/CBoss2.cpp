...
void CBoss2::update(float delta)
{
...
void CBoss2::handleCollisionWith(GameObject* gameObject)
{
//    if (this->hp<0) {
...
void CBoss2::atkHandler(float atk)
{
    hp -= atk;
    if (hp <= 0)
    {
