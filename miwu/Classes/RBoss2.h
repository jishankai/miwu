...
#ifndef __miwu__RBoss2__
#define __miwu__RBoss2__
...
class RBoss2 : public GameObject
{
...
private:
    ...
    void onEnter();
public:
    CCB_STATIC_NEW_AUTORELEASE_OBJECT_WITH_INIT_METHOD(RBoss2, create);
...
#endif /* defined(__miwu__RBoss2__) */
