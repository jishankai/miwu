...
#ifndef __miwu__WBoss__
#define __miwu__WBoss__
...
private:
    ...
    void onEnter();
public:
    CCB_STATIC_NEW_AUTORELEASE_OBJECT_WITH_INIT_METHOD(WBoss, create);
